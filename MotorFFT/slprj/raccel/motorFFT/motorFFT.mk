...
MODEL                   = motorFFT
MODULES                 = rt_logging.c motorFFT.c motorFFT_capi.c motorFFT_data.c motorFFT_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = motorFFT
MAKEFILE                = motorFFT.mk
MATLAB_ROOT             = /Applications/Polyspace/R2020a.app
ALT_MATLAB_ROOT         = /Applications/Polyspace/R2020a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Users/DELL/Desktop/7th\ Sem/MajorProject/MotorFFT
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACI64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/motorFFT \
