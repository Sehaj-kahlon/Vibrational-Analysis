...
( char_T * ) ( & rtB . gregxvrhdq ) , 0 , 0 , 24 } , { ( char_T * ) ( & rtDW
. azqf3zai0t . TimePtr ) , 11 , 0 , 48 } , { ( char_T * ) ( & rtDW .
i3mtw4xzzf . PrevIndex ) , 10 , 0 , 24 } } ; static DataTypeTransitionTable
rtBTransTable = { 3U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . fromWS_Signal1_Time0 [ 0 ] )
, 0 , 0 , 56580 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
